  ...
  $(document).ready(function () {
    $("#project-calendar").simpleCalendar({
      ...
      events: [
        ...
        {
          startDate: new Date(
            new Date().setHours(new Date().getHours() + 324),
          ).toDateString(),
          endDate: new Date(
            new Date().setHours(new Date().getHours() + 325),
          ).toISOString(),
          summary: "NFT Mobile Apps Developemnt",
        },
        {
          startDate: new Date(
            new Date().setHours(new Date().getHours() + 224),
          ).toDateString(),
          endDate: new Date(
            new Date().setHours(new Date().getHours() + 225),
          ).toISOString(),
          summary: "Meeting for campaign with sales team",
        },
        {
          startDate: new Date(
            new Date().setHours(new Date().getHours() + 124),
          ).toDateString(),
          endDate: new Date(
            new Date().setHours(new Date().getHours() + 125),
          ).toISOString(),
          summary: "React admin dashboard design",
        },
      ],
