...
($(function () {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#campaign-alytics-bar-chart"), {
      ...
      plotOptions: {
        bar: { horizontal: !1, endingShape: "rounded", columnWidth: "30%" },
      },
      dataLabels: {
        enabled: !1,
        offsetX: -6,
      ...
      legend: { show: !1, fontFamily: "Inter", labels: { colors: "#64748b" } },
    }).render();
  }),
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#social-radar-chart"), {
      ...
      chart: { height: 376, type: "radar", toolbar: { show: !1 } },
      colors: ["#560ce3", "#41B2C4", "#EA4D4D"],
      xaxis: { categories: ["Sun", "Mon", "Tue", "Wen", "Thu", "Fri"] },
      yaxis: { show: !1 },
      stroke: { show: !1, width: 0.5 },
      tooltip: {
        y: {
          formatter: function (e) {
            return +e + "K";
  ...
  $(document).ready(function () {
    ($('[data-time-countdown="countdown_1"]').timeTo(
      new Date("Tue Feb 23 2024 00:00:00 GMT+0600 (Bangladesh Standard Time)"),
    ),
      $('[data-time-countdown="countdown_2"]').timeTo(
        new Date(
          "Tue Feb 25 2024 00:00:00 GMT+0600 (Bangladesh Standard Time)",
        ),
      ),
      $('[data-time-countdown="countdown_3"]').timeTo(
        new Date(
          "Tue Feb 24 2024 00:00:00 GMT+0600 (Bangladesh Standard Time)",
        ),
      ),
      $('[data-time-countdown="countdown_4"]').timeTo(
        new Date(
          "Tue Feb 22 2024 00:00:00 GMT+0600 (Bangladesh Standard Time)",
        ),
      ),
      $('[data-time-countdown="countdown_5"]').timeTo(
        new Date(
          "Tue Feb 20 2024 00:00:00 GMT+0600 (Bangladesh Standard Time)",
        ),
      ));
  }),
  $(document).ready(function () {
