...
($(document).ready(function () {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#selling-status-area-chart"), {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#conversion-statistic-bar-chart"), {
      series: [
        {
      ...
      xaxis: {
        ...
        labels: { show: !0, style: { colors: "#fff", fontFamily: "Roboto" } },
        axisBorder: { show: !1 },
      },
      yaxis: { labels: { show: !1 } },
      tooltip: {
  ...
  $(document).ready(function () {
    new ApexCharts(document.querySelector("#traffic-source-area-chart"), {
      series: [
        {
          name: "New Visitors",
