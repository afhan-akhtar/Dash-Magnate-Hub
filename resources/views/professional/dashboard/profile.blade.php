...
@section('title', 'MagnateHub || My Profile')
@section('page_title', 'My Profile')
@section('page_summary', 'Update your account details, password, and brand assets from one organized professional workspace.')
