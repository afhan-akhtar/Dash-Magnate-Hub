                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mt-2">
                            ...
                            <select class="form-control" id="blog_category_ids" multiple size="4">
                                ...
                                <option value="{{ $cat->blog_category_id }}">{{ $cat->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 col-md-6 mt-2">
                            ...
                            <select class="form-control" id="blog_tag_ids" multiple size="6">
                                ...
                                <option value="{{ $tag->blog_tag_id }}">{{ $tag->name }}</option>
                                @endforeach
                            </select>
                            <small class="text-muted">Hold Ctrl/Cmd to select multiple</small>
                        </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="modern-image-upload">
                                <label class="modern-image-upload-label">
                                    Writer Image <span class="required">*</span>
                                </label>
                                <div class="modern-upload-area compact" id="writter_image_upload_area">
                                    <input type="file" class="modern-upload-input" id="writter_image" accept="image/png, image/gif, image/jpeg" required>
                                    <div class="modern-upload-preview" id="writter_image_preview" style="display: none;">
                                        <img id="writter_tag" src="" alt="Preview">
...
<script>
    ...
    $('#writter_image_upload_area').on('drop', function(e) {
        ...
        if (files.length > 0) {
            ...
            readURL($('#writter_image')[0], '#writter_image_preview', '#writter_image_upload_area', '#writter_image_upload_content');
        }
    });

    $("#writter_image").change(function() {
        readURL(this, '#writter_image_preview', '#writter_image_upload_area', '#writter_image_upload_content');
    });
</script>
