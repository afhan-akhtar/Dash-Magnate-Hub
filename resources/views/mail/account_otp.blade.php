...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p class="message">
                You're receiving this email to verify your account with <strong>MagnateHub</strong>.
            ...
            <p class="message">
                Enter this code on the verification page to access your dashboard and manage the platform.
            </p>
        ...
        <div class="email-footer">
            ...
            <p class="security-note">
                ...
                &copy; {{ date('Y') }} MagnateHub. All rights reserved.
            </p>
        </div>
    </div>
</body>
