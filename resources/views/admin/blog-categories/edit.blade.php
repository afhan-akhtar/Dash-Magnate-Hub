...
@section('page_subtitle', 'Update name, slug, ordering, and visibility.')
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit blog category</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <form method="POST" action="{{ route('admin.blog-categories.update', $category->id) }}">
                            ...
                            <div class="card stretch stretch-full profile-form-card mb-4">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted fs-12 mb-0">Changing the slug updates public URLs that rely on it.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            <div class="profile-form-note">
                                                ...
                                                <div class="text-muted fs-12 mb-0">View usage and linked posts on the <a href="{{ route('admin.blog-categories.show', $category->id) }}">category detail</a> screen.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
