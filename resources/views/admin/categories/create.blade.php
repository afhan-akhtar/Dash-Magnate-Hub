...
@section('page_subtitle', 'Add a new category with name, URL, visibility, and optional image.')
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                   ...
                                                   placeholder="e.g. Accommodation and Tourism" required>
                                            @error('name')
                                        ...
                                        <div class="col-12">
                                            <div class="profile-form-note">
                                                ...
                                                <div class="text-muted fs-12 mb-0">Use lowercase letters, numbers, and hyphens only. This becomes the public path segment for the category.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
