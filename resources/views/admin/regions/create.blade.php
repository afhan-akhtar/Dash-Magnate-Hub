...
@section('page_title', 'Create Region')
@section('page_subtitle', 'Add a region and assign it to a location.')
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Create region</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <form method="POST" action="{{ route('admin.regions.store') }}">
                            ...
                            <div class="card profile-form-card mb-4">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted fs-12 mb-0">Each region belongs to one location used for filtering and listings.</p>
                                </div>
                                <div class="card-body">
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            <div class="profile-form-note">
                                                ...
                                                <div class="text-muted fs-12 mb-0">Manage the parent list under <a href="{{ route('admin.locations.index') }}">Locations</a> if you need a new area first.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3 mb-5">
                                ...
                                <button type="submit" class="btn btn-primary px-5">
                                    <i class="feather-save me-1"></i> Create region
                                </button>
                            </div>
                        </form>
                    </div>
